...
2. Click on this link: [https://github.com/pewpasta/Bot-1/raw/master/placenlbot.user.js](https://github.com/pewpasta/Bot-1/master/placenlbot.user.js). If everything went well you'll see Tampermonkey ask you to add it. Click **Install**.
